...
public class Desert implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + Objects.hashCode(this.hazards);
    ...
    public String toString() {
        return "Desert{" + "description=" + description + ", resourceType=" + resourceType + ", hazards=" + hazards + ", travelTime=" + travelTime + ", amountAvailable=" + amountAvailable + '}';
    }
